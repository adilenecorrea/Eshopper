<?php
 ...
 foreach($filas as $value){
  ...
  //En está parte se definenen los arreglos, para indicar en donde se van colocar cada dato
?>
...
<head>
    ...
    <meta name="Brenda Adilene Correa Antuna" content="">
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> 618 146 0136 </a></li>
		...
		<div class="header-middle"><!--header-middle-->
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-8">
						Por: Brenda Adilene Correa Antuna
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								<li><a href="AgregarProductos.php" target="_blank"><i class="fa fa-plus"></i>Agregar</a></li>
								<!--Aqui se agrega un nuevo botón y se indica de donde se van a sacar los datos para ese nuevo boton--> 
			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						...
						//En está parte se indica la función del ciclo para ejecutar las imagenes
						?>
						<div class="col-sm-4">
						...
						<?php 
						$n+=4;
						//Aqui se genera el codigo para acomodar las imagenes  
					}
					 ?>
					</div><!--features_items-->
										...
										<div class="product-image-wrapper">
											...
											<div class="single-products">
												<div class="productinfo text-center">
													...
													<p>Sudadera Gris</p>
													<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Agregar al Carrito</a>
                                                <!--/En está parte se codifica todo para establecer las imagenes que deben aparecer--> 
												</div>
